   ...
   #  GLB.vref
	...
	self.log(GLB.debugType, "iref = " + str(GLB.iref) + "\n")
        ...
        while not self.stop.isSet():
            ...
            v1Reading = str(round(self.getVoltageReading(TSdata[GLB.TS_DATA_V1] * GLB.ADC_3_3V_RATIO * GLB.VOLTAGE_ADC_RATIO, GLB.DECIMAL_ACCURACY)))
            v2Reading = str(round(self.getVoltageReading(TSdata[GLB.TS_DATA_V2] * GLB.ADC_3_3V_RATIO * GLB.VOLTAGE_ADC_RATIO, GLB.DECIMAL_ACCURACY)))
            v3Reading = str(round(self.getVoltageReading(TSdata[GLB.TS_DATA_V3] * GLB.ADC_3_3V_RATIO * GLB.VOLTAGE_ADC_RATIO, GLB.DECIMAL_ACCURACY)))
            t1Reading = ""
            t2Reading = ""
            try:
